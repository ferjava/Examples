...
add_library(Allegro::allegro_primitives STATIC IMPORTED)
...
add_library(Allegro::allegro_image STATIC IMPORTED)
...
add_library(Allegro::allegro_font STATIC IMPORTED)
...
add_library(Allegro::allegro_audio STATIC IMPORTED)
...
add_library(Allegro::allegro_acodec STATIC IMPORTED)

set_target_properties(Allegro::allegro_acodec PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "Allegro::allegro_audio;/usr/lib/libFLAC.so;/usr/lib/libogg.so;/usr/lib/libopenmpt.so;/usr/lib/libvorbisfile.so;/usr/lib/libvorbis.so;/usr/lib/libogg.so"
)

# Create imported target Allegro::allegro_ttf
add_library(Allegro::allegro_ttf STATIC IMPORTED)
...
add_library(Allegro::allegro_color STATIC IMPORTED)
...
add_library(Allegro::allegro_memfile STATIC IMPORTED)
...
add_library(Allegro::allegro_dialog STATIC IMPORTED)

set_target_properties(Allegro::allegro_dialog PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "gtk-3;gdk-3;z;pangocairo-1.0;pango-1.0;harfbuzz;atk-1.0;cairo-gobject;cairo;gdk_pixbuf-2.0;gio-2.0;gobject-2.0;glib-2.0;gthread-2.0;glib-2.0;Allegro::allegro"
)

# Create imported target Allegro::allegro_video
add_library(Allegro::allegro_video STATIC IMPORTED)
...
add_library(Allegro::allegro_main STATIC IMPORTED)
